...
Asi despues de 1000 y un intentos, se logro entender como puede funcionar la carga de paquetes y que todo este correcto. Con este pequeño script `llamarpy275.sh`
...
# output files to run
#
#$ -o ../llamada.$JOB_ID.out # Salida estandar
#$ -e ../llamadaoutput.$JOB_ID.err # Archivo con los errores
#
# If modules are needed, source modules environment (Do not delete the next line):
#  Con el gato, ya no necesitamos algun modulo de ambiente.
#
...
print("Primeras paqueterias necesarias")
...
print("Ahora RandomForest")

try:
        from sklearn.model_selection import train_test_split
        from sklearn.ensemble import RandomForestRegressor
        print("train_test_split cargado")
        print("RandomForestRegressor cargado")

except ImportError:
        print("train_test_split o RandomForestRegressor no están cargados")

END
```
Lo cual como todo funciona bien, se cargaron los paquetes necesarios
```
Primeras paqueterias necesarias
('NumPy version:', '1.16.2')
('pandas version:', u'0.24.2')
Ahora RandomForest
train_test_split cargado
RandomForestRegressor cargado
llamada.472243.out (END)
```

Por tanto para cuando sea requerido `RandomForest` sera necesario colocar esta parte al inicio del codigo python `# -*- coding: utf-8 -*-`
y mientras al script de la matriz no.

# Fecha 13 de mayo del 2024
Ahora si con las modificaciones, lo podemos aplicar comodamente al codigo de la matriz.
```
#!/bin/bash
# Use current working directory
#$ -cwd
